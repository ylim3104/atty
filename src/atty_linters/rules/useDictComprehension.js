...
exports.UseDictComprehension = void 0;
const baseRule_1 = require("./baseRule");
const vscode = __importStar(require("vscode"));
class UseDictComprehension extends baseRule_1.BaseRule {
    messages;
    ...
    collectEmptyDictAssignments(node, emptyDicts) {
    ...
    checkLoopAssignments(diagnostics, node, emptyDicts) {
        if (node.type === 'for_statement') {
            ...
            for (const name of emptyDicts) {
                if (text.includes(`${name}[`)) {
                    ...
                    diagnostics.push(new vscode.Diagnostic(range, this.messages.useDictComprehension, vscode.DiagnosticSeverity.Warning));
                    break;
                }
            }
        }
...
exports.UseDictComprehension = UseDictComprehension;
//# sourceMappingURL=useDictComprehension.js.map