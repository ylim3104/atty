...
exports.ZeroDivisionErrorRule = void 0;
const baseRule_1 = require("./baseRule");
const vscode = __importStar(require("vscode"));
class ZeroDivisionErrorRule extends baseRule_1.BaseRule {
    messages;
        ...
        if (node.type === 'binary_operator') {
            ...
            for (let i = 0; i < children.length - 1; i++) {
                if (children[i].type === '/' &&
                    ...
                    diagnostics.push(new vscode.Diagnostic(range, this.messages.zeroDivisionError, vscode.DiagnosticSeverity.Error));
                }
            }
        }
...
exports.ZeroDivisionErrorRule = ZeroDivisionErrorRule;
//# sourceMappingURL=zeroDivisionError.js.map