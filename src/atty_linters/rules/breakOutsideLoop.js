...
exports.BreakOutsideLoop = void 0;
const baseRule_1 = require("./baseRule");
const vscode = __importStar(require("vscode"));
class BreakOutsideLoop extends baseRule_1.BaseRule {
    messages;
    ...
    walk(diagnostics, node, insideLoop = false) {
        if (!this.messages)
            return;
        const nowInsideLoop = insideLoop ||
        ...
        if ((node.type === 'break_statement' || node.type === 'continue_statement') &&
            ...
            diagnostics.push(new vscode.Diagnostic(range, this.messages.breakOutsideLoop, vscode.DiagnosticSeverity.Error));
        }
...
exports.BreakOutsideLoop = BreakOutsideLoop;
//# sourceMappingURL=breakOutsideLoop.js.map